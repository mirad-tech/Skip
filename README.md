...
- [下载 Skip 1.0.12 release APK](https://github.com/mirad-tech/Skip/releases/download/v1.0.12/Skip-v1.0.12-release.apk)
...
1. 安装 `Skip-v1.0.12-release.apk`，或从当前源码构建安装包。
