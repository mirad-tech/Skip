...
- [下载最新已发布的 Skip 1.0.11 release APK](https://github.com/mirad-tech/Skip/releases/download/v1.0.11/Skip-v1.0.11-release.apk)
...
1. 安装最新已发布的 `Skip-v1.0.11-release.apk`，或从当前 `1.0.12` 源码构建安装包。
