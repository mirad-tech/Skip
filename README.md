...
- [下载 Skip 1.0.10 release APK](https://github.com/mirad-tech/Skip/releases/download/v1.0.10/Skip-v1.0.10-release.apk)
...
1. 安装 `Skip-v1.0.10-release.apk`，或从当前源码构建安装包。
