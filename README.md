...
- [下载最新已发布的 Skip 1.0.12 release APK](https://github.com/mirad-tech/Skip/releases/download/v1.0.12/Skip-v1.0.12-release.apk)
- SHA256：`70FAEEDF4000A0FDEE3E01B10FD0A582AFFFD0DFBF65678AAF9613A10B9BC26C`

> 更新提示：1.0.7 的应用内更新可能因 SHA-256 digest 格式误判失败，不能通过应用内更新直接升级到最新版。请从 GitHub Release 手动下载 v1.0.12 APK 覆盖安装一次；从 v1.0.8 起后续应用内更新恢复正常。
...
1. 安装最新已发布的 `Skip-v1.0.12-release.apk`，或从当前 `1.0.13` 源码构建安装包。
