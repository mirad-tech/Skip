...
- [下载最新已发布的 Skip 1.0.10 release APK](https://github.com/mirad-tech/Skip/releases/download/v1.0.10/Skip-v1.0.10-release.apk)
- SHA256：`3FC55B19CBC86ADC5B98691867E2B0A9E1FEFD098B6A7B0E6A660866F1C9D471`

> 更新提示：1.0.7 的应用内更新可能因 SHA-256 digest 格式误判失败，不能通过应用内更新直接升级到最新版。请从 GitHub Release 手动下载 v1.0.10 APK 覆盖安装一次；从 v1.0.8 起后续应用内更新恢复正常。
...
1. 安装最新已发布的 `Skip-v1.0.10-release.apk`，或从当前 `1.0.11` 源码构建安装包。
